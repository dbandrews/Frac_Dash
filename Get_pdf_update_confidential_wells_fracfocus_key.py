...
from Get_pdf_update_by_fracfocus_key import Get_pdf_update_by_fracfocus_key
...
Get_pdf_update_by_fracfocus_key(frac_key_list,r'C:/Program Files (x86)/chromedriver_win32/chromedriver.exe')