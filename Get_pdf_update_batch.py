...
def Get_pdf_update_batch(pdf_per_page,num_pages,path_to_driver):
    ...
    Only downloads PDFs not already in path/AB_PDFs folder, this is created if it doesn't exist. If error occurs, waits 
    ...
    for j in range(1,num_pages+1):
        for i in range(1,pdf_per_page+1):
            try:
                ...
                #Error on accesing frac focus page,give 30 secondsn then try again
